...
const plans = [
  ...
  },
  {
    ...
    fee: "$800",
    extras:
      "Includes smart-filtering engine and up to 3 hiring manager seats",
  },
  {
    size: "Scale-Up",
  ...
  },
  {
    ...
    extras:
      "Dedicated success manager • Custom analytics & API access",
  },
];
      ...
      <Container className="space-y-10 md:space-y-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="p-5 sm:p-6 lg:p-8 rounded-3xl border border-box-border bg-box-bg shadow-lg shadow-box-shadow relative overflow-hidden space-y-4 max-w-[320px] mx-auto text-left"
            >
