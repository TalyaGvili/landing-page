        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingPlans.map((plan, key) => (
            <div key={key} className="relative group h-full">
              <div className="bg-gradient-to-r from-orange-500 via-orange-400 to-amber-300 p-1 rounded-3xl h-full">
                <div
                ...
                >
                  {plan.bestValue && (
                    <div
                      className="absolute -top-3 left-1/2 -translate-x-1/2 text-white text-xs font-bold uppercase tracking-wider
                                 px-3 py-1 rounded-full bg-gradient-to-r from-orange-500 via-orange-400 to-amber-300"
                    >
                      Best Value
                    </div>
                  )}
                  ...
                  <div className="mt-8">
<Button
  className="w-full bg-gradient-to-r from-orange-500 via-orange-400 to-amber-300 text-white font-semibold py-2 px-4 rounded-xl shadow-md hover:scale-105 transition-transform duration-300">
  Choose Plan
</Button>
